...
#
# pickle.dump(yumigear_nf, open("yumigear_nf.p", "wb"))

yumigear_nf = pickle.load( open( "yumigear_nf.p", "rb" ) )
width = 2
offset = [2]
for i in [0]:
...
plt.text(0.03, 0.05, '(a)', fontweight='bold', fontsize=font_size_2, transform=plt.gcf().transFigure)
plt.text(0.54, 0.05, '(b)', fontweight='bold', fontsize=font_size_2, transform=plt.gcf().transFigure)
plt.subplots_adjust(left=0.12, bottom=0.23, right=.99, top=0.8, wspace=0.4, hspace=0.7)
fig1.savefig("yumi_nf_gear_rl_progress.pdf")
